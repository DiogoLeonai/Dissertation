...
unset xtics
unset ytics
splot 'FASE_R55.0_gexc0.1600.dat' u 1:2:(($3+25068)/1000):100 w points pt 7 ps 1 lc palette notitle, \
    'FASE_R55.0_gexc0.1600.dat' u 1:2:(($3+25075)/1000):110 w points pt 7 ps 1 lc palette notitle, \
    'FASE_R55.0_gexc0.1600.dat' u 1:2:(($3+25085)/1000):120 w points pt 7 ps 1 lc palette notitle, \
    'FASE_R55.0_gexc0.1600.dat' u 1:2:(($3+25095)/1000):125 w points pt 7 ps 1 lc palette notitle, \
    'FASE_R55.0_gexc0.1600.dat' u 1:2:(($3+25105)/1000):140 w points pt 7 ps 1 lc palette notitle
...
unset zlabel
unset colorbox
splot 'PHASE_R75.0_gexc0.128.dat' u 1:2:(($3+25068)/1000):60 w points pt 7 ps 1 lc palette notitle, \
    'PHASE_R75.0_gexc0.128.dat' u 1:2:(($3+25075)/1000):65 w points pt 7 ps 1 lc palette notitle, \
    'PHASE_R75.0_gexc0.128.dat' u 1:2:(($3+25085)/1000):75 w points pt 7 ps 1 lc palette notitle, \
    'PHASE_R75.0_gexc0.128.dat' u 1:2:(($3+25095)/1000):80 w points pt 7 ps 1 lc palette notitle, \
    'PHASE_R75.0_gexc0.128.dat' u 1:2:(($3+25105)/1000):85 w points pt 7 ps 1 lc palette notitle
...
unset cblabel
#set title '(a)' font 'Times-Roman, 40pt' offset -17,-0.5
plot 'LocalZ_R75.0_gexc_0.128.dat' u 1:2:3 w image notitle
